  ...
  group('SignUp', () {
    test('can sign up with emailCode in separate steps', () async {
      await runWithLogging(() async {
        ...
        httpService.expect(
          'PATCH /v1/client/sign_ups/SIGN_UP_ATTEMPT_ID strategy=email_code&code=424242',
          200,
    ...
    test('can sign up with phoneCode in separate steps', () async {
      await runWithLogging(() async {
        ...
        httpService.expect(
          'PATCH /v1/client/sign_ups/SIGN_UP_ATTEMPT_ID strategy=phone_code&code=424242',
          200,
